...
const TableList = () => {
  ...
  return (
    <div className="container__table__ManageBussinesss pb-2">
              ...
              <tr key={index}>
                ...
                <td>
                  <div className="d-flex justify-content-center align-items-center">
                    <p className="btn_verify_user bg-success text-white mx-1">
                      فعال
                    </p>
                    <p className="btn_verify_user bg-danger text-white mx-1">
                      غیر فعال
                    </p>
                  </div>
                </td>
                <td>مشاهده‌‌ی پروفایل</td>
              </tr>
            );
          })}
        </tbody>
