    ...
    <>
      <div className="container-fluid p-0 m-0 pt-5">
        <div className="row p-0 m-0 justify-content-center align-items-center ">
          <div className="col-lg-6 col-md-7 col-md-11 col-11 p-0 m-0 d-flex justify-content-center align-items-center">
            <div
              className={`contaner__choiceIMg`}
              style={{ background: background }}
            >
              <div>
                <p className="m-0 title__choice__image text-right fontfamily fony80">
                  {title}
                </p>
              </div>
              <div className="input__choice__file">
                <label className="custom-file-upload">
                  ...
                  />
                  <img
                    className="arrow__icon__choice_File"
                    src={Arrow}
                    alt="arrow-left"
                  />
                </label>
            ...
            <div className="img__choiced__user">
              <img
...
export default memo(ContainerDetailsBule);
